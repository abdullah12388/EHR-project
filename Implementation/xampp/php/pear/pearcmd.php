...
if ('E:\EHR-project\Implementation\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('E:\EHR-project\Implementation\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
